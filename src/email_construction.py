        ...
        <tr>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff;">
                ...
                <td style="padding: 30px;">
                    ...
                    <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #4b5563;">Cada mañana, recibí en tu correo un informe seleccionado con lo que realmente mueve a la Argentina:
                    <strong>política, economía, mercados, dólar, deportes, cultura y panorama internacional.</strong>
                    </p>
                </td>
                </tr>  
                <tr>
                <td align="center" style="padding-bottom: 20px;">
                    ...
                    <strong>🔥 SUSCRIBIRME AHORA – $9.999/mes</strong>
                    </a>  
                </td>
                </tr>         
                <tr>
